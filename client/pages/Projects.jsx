...
const allProjects = [
  {
    ...
    category: "Game",
    description:
      "A roguelike adventure where you battle using the periodic table. Strategize and combine elements to conquer enemies.",
    techStack: ["Godot", "iOS", "Android", "Web"],
    demoLink: "https://brandersonstudio.itch.io/atomicallies",
    githubLink: "#",
  ...
  },
  {
    ...
    category: "Game",
    description:
      "An idle progression game where you collect rain, buy flowers, and utilize prestige mechanics to grow your tranquil garden.",
    techStack: ["Godot", "iOS", "Android", "Web"],
  ...
  },
  {
    ...
    category: "Web App",
    description:
      "The very site you are looking at right now! Built to showcase my journey as a developer and host web-playable versions of my games.",
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 dark:text-slate-100 mb-4 transition-colors">
          My Projects
        </h1>
          ...
          >
            <div className="h-48 bg-slate-200 dark:bg-slate-800 flex items-center justify-center border-b border-slate-200 dark:border-slate-800 relative overflow-hidden transition-colors">
              {project.image ? (
                ...
                <span className="text-slate-400 dark:text-slate-500 font-medium group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="p-6 flex-grow">
              <h4 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-3 transition-colors">
                {project.title}
              </h4>
              <p className="text-slate-600 dark:text-slate-400 mb-4 text-sm leading-relaxed transition-colors">
                {project.description}
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {project.techStack?.map((tech, index) => (
                  <span
                    key={index}
                    className="bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400 text-xs font-semibold px-2.5 py-1 rounded border border-teal-200 dark:border-teal-800 transition-colors"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="bg-slate-50 dark:bg-slate-950/50 px-6 py-4 border-t border-slate-200 dark:border-slate-800 flex justify-between items-center mt-auto transition-colors">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-teal-600 dark:text-teal-500 hover:text-teal-800 dark:hover:text-teal-400 text-sm font-bold transition-colors"
              >
                View Project &rarr;
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 text-sm font-bold transition-colors"
              >
                Source Code
              </a>
            </div>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                {selectedProject.image && (
                  <img
                    ...
                    className="w-16 h-16 md:w-20 md:h-20 object-contain drop-shadow-md rounded-xl"
                  />
                )}
                <div>
                  <div className="mb-1 text-xs font-bold text-teal-600 dark:text-teal-400 uppercase tracking-wider">
              ...
              <div className="flex justify-end gap-3 md:gap-4 items-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600 text-white px-6 py-2 rounded-lg text-sm font-bold transition-colors shadow-sm"
                >
                  View Project &rarr;
                </a>
              </div>
